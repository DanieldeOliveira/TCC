...
sampleplayer.CastPlayer = function(element) {
  ...
  this.interacao =  this.getElementByClass_('.elementosInteracao');
  ...
  /* Parte da interação do aplicativo */


  messageBusSenderToChromecast = this.receiverManager_.getCastMessageBus('urn:x-cast:DevCastSenderToChromecast');
...
sampleplayer.CastPlayer.prototype.onPlaying_ = function() {
  ...
  console.log("Entrou no metodo onPlaying_");


  var imagens = document.getElementsByClassName('imgSlide');
  console.log(imagens);
